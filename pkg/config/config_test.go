...
func TestNewConfigFromFile(t *testing.T) {
	...
	cfg, err = NewConfigFromFile("../../test/data/configs/valid/accounts.yaml")
	require.Nil(err)
	...
	cfg, err = NewConfigFromFile("../../test/data/configs/valid/")
	require.Nil(err)
	//fmt.Println(yaml.FormatError(err, true, true))
	require.Equal("imap.server.de", cfg.Accounts["test"].Connection.Server)

	// Failed file/dir loading
	cfg, err = NewConfigFromFile("../../test/data/configs/does-not-exist")
	require.EqualError(err, "stat ../../test/data/configs/does-not-exist: no such file or directory")

	// Reading broken file
	cfg, err = NewConfigFromFile("../../test/data/configs/invalid/zero-file.yaml")
	...
	cfg, err = NewConfigFromFile("../../test/data/configs/invalid-unreadable-file/")
...
func TestFilterSet_Names(t *testing.T) {
	...
	// load test data
	cfg, err = NewConfigFromFile("../../test/data/configs/valid/local_imap_server/TestFilterSet_Names")
	require.Nil(err)
